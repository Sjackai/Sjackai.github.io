...
// Controls if the calculator should keep running
let keepGoing = true;

// Keeps asking the user for calculations while they click OK
while (keepGoing) {
    ...
    // OK repeats the calculator and Cancel ends it
    keepGoing = confirm("Would you like to perform another calculation?");
}
